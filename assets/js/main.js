...
$(function(){// raccourci pour $(document).ready(function() { ... }); qui est là pour s'assurer que la fonction 
  //est appelée une fois tous les eléments du DOM sont tous chargés et préts à être utilisés
  //remplace , le $ peut etre remplacé par jQuery

  var cards = [{// variable cards sous forme de tableau pour afficher la carte selon les n° saisis
    nome: "mastercard",
    colore: "#0061A8",
  ...
  // fonction  lorsque l'on clique  sur les inputs pour changer la couleur d'ecriture
  ...
  //Card number input
  // fonction qui affiche la carte en fonction des valeurs saisi par l'utilisateur dans n° carte
  //test sur les 2 premiers caractéres ou 4 premier
  // selon le resultat du test selectionne la carte correspondante dans le tableau card en variable 
  $(".number").keyup(function(event){
    ...
    //recupération et application de la couleur et du logo en fonction de selected_card au dessus
    if(selected_card != -1){
    ...
    // affiche les ronds à la place des nombres si 0 chiffre entré
    if($(".card_number").text().length === 0){
      $(".card_number").html("&#x25CF;&#x25CF;&#x25CF;&#x25CF; &#x25CF;&#x25CF;&#x25CF;&#x25CF; &#x25CF;&#x25CF;&#x25CF;&#x25CF; &#x25CF;&#x25CF;&#x25CF;&#x25CF;");
    }
//fonction pour affichage sur la carte des nombres saisi 
  }).focus(function(){
  ...
  //fonction lier au nom du titulaire
  //Name Input
  $(".inputname").keyup(function(){  
    $(".fullname").text($(this).val());  
    if($(".inputname").val().length === 0){
        $(".fullname").text("Nom du titulaire");
    }
    return event.charCode;
  }).focus(function(){
    $(".fullname").css("color", "white");
  });
  // fonction sur ccv affichge des points si rien n'est saisi
  //Security code Input
  $(".ccv").focus(function(){
  ...
  // fonction pour la date d'expiration 
  //Date expire input
